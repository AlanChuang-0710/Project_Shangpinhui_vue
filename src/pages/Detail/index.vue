    ...
    <section class="con">
      ...
      <div class="conPoin">
        <span v-show="categoryView.category1Name"
          ><a href="javascript:;">{{ categoryView.category1Name }}</a></span
        >
        <span v-show="categoryView.category2Name"
          ><a href="javascript:;">{{ categoryView.category2Name }}</a></span
        >
        <span v-show="categoryView.category3Name"
          ><a href="javascript:;">{{ categoryView.category3Name }}</a></span
        >
      </div>
      <!-- 主要內容區域 -->
      <div class="mainCon">
        ...
        <div class="InfoWrap">
            ...
            <div class="priceArea">
              ...
              <div class="priceArea2">
                ...
                <div class="fixWidth">
                  ...
                  <em class="t-gray"
                    >滿999.00另加20.00元，或滿1999.00另加30.00元，或滿2999.00另加40.00元，即可在購物車換購熱銷商品</em
                  >
                </div>
              </div>
            </div>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="changeActive(spuSaleValue, spuSaleAttr.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a @click="addShopCart" style="cursor: pointer">加入購物車</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async addShopCart() {
      // 調用store的addOrUpdateShopCart 其為async function 返回的就是 promise
      try {
        await this.$store.dispatch("addOrUpdateShopCart", {
          skuNum: this.skuNum,
          skuId: this.$route.params.skuId,
        });
        // 如果返回的promise為成功的，代表倉庫成功存儲數據，也就可以顯示"成功加入購物車" 並且 進行路由跳轉
        // 進行路由跳轉，將產品信息帶給路由跳轉對象，簡單數據以query進行傳遞
        // 複雜數據如skuInfo，以sessionStorage進行傳遞
        // 本地存儲 | 會話存儲 一般以字串存儲
        this.$router.push({
          name: "AddCartSuccess",
