        ...
        <div class="loginform">
          ...
          <div class="content">
            <form>
              ...
              <button class="btn" @click.prevent="userLogin">登&nbsp;&nbsp;錄</button>
            </form>

            <div class="call clearFix">
              <ul>
                <li><img src="@/assets/qq.png" alt="" /></li>
                <li><img src="@/assets/sina.png" alt="" /></li>
                <li><img src="@/assets/ali.png" alt="" /></li>
        ...
        form {
          ...
          .input-text {
            ...
            span {
              ...
              // 如果圖片存放在assets中的話，要使用以下方式進行引用
              // 如果圖片存放在public/images中的話，可以使用run build後產生之絕對路徑
